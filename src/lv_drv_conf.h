 ...
 * DELAY INTERFACE
 *********************/
#define LV_DRV_DELAY_INCLUDE <mbed.h>   /*Dummy include by default*/
#define LV_DRV_DELAY_US(us) wait_us(us) /*Delay the given number of microseconds*/
#define LV_DRV_DELAY_MS(ms) wait_ms(ms) /*Delay the given number of milliseconds*/
...
#define LV_DRV_SET_FREQUENCY(val) spi_set_freq(val)         /*Delay the given number of milliseconds*/
